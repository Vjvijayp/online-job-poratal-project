...
<tr><td bgcolor="skyblue"bgcolor="skyblue"bgcolor="#ffffff"
background="C:\Users\Admin\Desktop\2.jpg" background-position:"fixed"
background-repeat:"no-repeat"><center>EMPLOYER'S LOGIN</center>
<table cellpadding=0 cellspacing=0 border=0 width=100%><tr>
<br>
<td bgcolor="grey" align=left style="padding:2;padding-bottom:4">
<b><font size=4 color="white"face="Roman"><b>Enter your
Credentials...</b></font></td></tr>
<tr><td bgcolor="white" style="padding:5"><br>
<form method="post" action="newlogin_e.jsp" name=pform>
<center><table>
...
<a href="newemp_reg.jsp">here</a> to register.</td></tr>
...
String sql = "select * from newemployer where emp_name='"+k1+"'";
//and password='"+k2+"'";
...
{
%>
 <jsp:forward page="newemp_home.jsp" />
<%}
else
{
%>
